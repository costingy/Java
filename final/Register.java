...
public class Register extends javax.swing.JFrame
{
    ...
    {//GEN-HEADEREND:event_JBUpdateUserActionPerformed
        ...
        model.setValueAt(password, row, 2);
         ...
         String newData = name + ", " + id + ", " + password + ", " + topup;
         
          
         editLineInFile("C:\\Users\\chiaj\\OneDrive\\Documents\\NetBeansProjects\\Assignment\\src\\assignment\\password.txt", id, newData);
    ...
    private void editLineInFile(String filePath, String idToEdit, String newData) {
    ...
    try {
        ...
        // Edit the line corresponding to the given ID
        for (int i = 0; i < lines.size(); i++) {
            String[] data = lines.get(i).split(", ");
            if (data.length >= 2) {
                String id = data[1].trim(); // Assuming id is the second element

                if (idToEdit.equals(id)) {
                    // Modify the data as needed
                    // For example, if newData is a string with updated information
                    String updatedLine = newData;

                    // Update the line in the list
                    lines.set(i, updatedLine);

                    break; // Exit the loop once the line is edited
                }
            }
        }
    ...
    {//GEN-HEADEREND:event_jBDeleteUserActionPerformed
        ...
        // Remove the user information from password.txt
        removeLineFromFile("C:\\Users\\chiaj\\OneDrive\\Documents\\NetBeansProjects\\Assignment\\src\\assignment\\password.txt", id);
    ...
    private void removeLineFromFile(String filePath, String idToRemove) {
    File file = new File(filePath);
    ...
    try {
        ...
        // Remove the line corresponding to the given ID
        for (int i = 0; i < lines.size(); i++) {
            String[] data = lines.get(i).split(", ");
            if (data.length >= 2) {
                String id = data[1].trim(); // Assuming id is the second element
                ...
                if (idToRemove.equals(id)) {
                    ...
                    break; // Exit the loop once the line is removed
                }
            }
        }
